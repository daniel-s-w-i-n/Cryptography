package uk.ac.nottingham.cryptography.Ciphers.Zodiac;
...
public class KeyScheduleTests {
    ...
    void fullKeyScheduleTestTwo() {
        byte[] dpad = new byte[]{-20, 47, -119, -116, 90, -10, 27, -127, -115, 11, -58, -93, -21, -102, 41, 104};
        byte[] kpad = new byte[]{40, 10, 89, 58, 64, -101, -52, -86, 113, -68, 28, 39, -70, -45, -39, -40};
        int[] keySum = new int[8];
        ...
        int[] expectedkeySum = new int[] { -318, 1633, -1401, -219, -199, -731, -1100, 489 };
